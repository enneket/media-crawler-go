...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /crawler/start", s.handleAPICrawlerStart)
	s.mux.HandleFunc("POST /crawler/stop", s.handleAPICrawlerStop)
	s.mux.HandleFunc("GET /crawler/status", s.handleAPICrawlerStatus)
